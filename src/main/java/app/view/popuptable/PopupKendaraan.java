...
public class PopupKendaraan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Kendaraan", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void tablekendaraanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablekendaraanMouseClicked
        ...
        int tablekndrn = tablekendaraan.getSelectedRow();
        kendaraan.idkk = tablekendaraan.getValueAt(tablekndrn, 0).toString();
        kendaraan.jeniskk = tablekendaraan.getValueAt(tablekndrn, 2).toString();
        kendaraan.modelk = tablekendaraan.getValueAt(tablekndrn, 3).toString();
        kendaraan.pltnmr = tablekendaraan.getValueAt(tablekndrn, 4).toString();
        kendaraan.itemTerpilihKndrn();
        this.dispose();
